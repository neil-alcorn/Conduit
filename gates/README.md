...
- [gates/sync/gate-sync.sh](./sync/gate-sync.sh)
- [gates/protocols/release-gate.yaml](./protocols/release-gate.yaml)

See [docs/architecture.md](../docs/architecture.md) and [docs/current-state.md](../docs/current-state.md) for how gate protocols relate to current implementation status.
