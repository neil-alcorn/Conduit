...
CONDUIT is an AI-native software delivery orchestration system designed for regulated, multi-system, multi-audience environments — usable on personal projects or any organization.
...
3. Audience impact — end-user experience, employee workflow, and vendor/partner effects — must be explicit delivery outputs, not implied side effects.
...
End users, employees, and vendor/partner audiences are explicit parts of delivery decisions. CONDUIT treats audience impact as a first-class concern.
...
The Eisenhower Initiative is the one-time program for bringing repos onto the CONDUIT network through Highway Init and Highway Index registration.
...
- shared JSON schemas
- shared constants
- shared work-tracker field mappings
...
- [docs/concept/vision-and-architecture.md](./concept/vision-and-architecture.md)
